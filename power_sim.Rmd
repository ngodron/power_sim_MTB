...
Another assumption is the confounding contribution of all resistances, which here will be set at $5$%, so $h^2\_res = 25%$.
This heritability would gain from managing resistance-induced bias, such as designing a resistance covariate.
Furthermore, the heterogeneity of the 'extra-pulmonary' phenotype can be seen as a further loss in heritability (again set at 5%).
